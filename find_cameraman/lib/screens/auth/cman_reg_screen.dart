...
import 'package:find_cameraman/services/auth_C_man_service.dart';
...
class CmanRegScn extends StatefulWidget {
  const CmanRegScn({super.key});

  @override
  State<CmanRegScn> createState() => _CmanRegScnState();
}

class _CmanRegScnState extends State<CmanRegScn> {
  ...
  bool isLoading = false;
   ...
   final autthCmanMethodes _authMethodes = autthCmanMethodes();
  ...
  void registerUser() async {
    ...
    if (res == "Cameraman Registration Successful") {
    ...
    return Scaffold(
      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          // submit button
          SubmitButton(text: "Register", onPressed: registerUser),
          Row(
